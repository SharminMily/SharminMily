<img src="./images/banner.png" alt="Sharmin Akther - Full-Stack Developer" width="100%" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />

<h1 align="center" style="color: #2c3e50; font-family: 'Arial', sans-serif; border-bottom: 2px solid #3498db; padding-bottom: 10px;">Sharmin Akther</h1>
<h3 align="center" style="color: #7f8c8d; font-style: italic;">Passionate Full-Stack Developer from Bangladesh 🇧🇩</h3>

<div align="center" style="margin: 20px 0;">
  <img src="https://media.giphy.com/media/M9gbBd9nbDrOTu1Mqx/giphy.gif" alt="Coding GIF" width="200" style="border-radius: 50%; border: 3px solid #3498db;" />
</div>
...
<div align="center" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin: 20px 0;">
  <img src="https://github-readme-stats.vercel.app/api/top-langs?username=sharminmily&show_icons=true&locale=en&layout=compact&theme=radical" alt="Top Languages" style="width: 100%; border-radius: 10px;" />
  <img src="https://github-readme-stats.vercel.app/api?username=sharminmily&show_icons=true&locale=en&theme=radical" alt="GitHub Stats" style="width: 100%; border-radius: 10px;" />
...
- **[Bicycle Store](https://bicycle-store-fontend.vercel.app/)**: A responsive e-commerce platform for bicycle enthusiasts, featuring dynamic inventory management and user authentication. (Tech: Next.js, Prisma, Tailwind CSS)
- **[Next Events](https://next-event-pro.vercel.app)**: An event management app with real-time updates, RSVP features, and intuitive UI. (Tech: Next.js, MongoDB, Firebase)
<!-- - **[Camps Medical](https://camps-medical.surge.sh)**: A healthcare portal for medical camps, including appointment booking and resource tracking. (Tech: React, Node.js, PostgreSQL) -->

Each project is designed to be fully responsive, ensuring a great experience on mobile, tablet, and desktop.
